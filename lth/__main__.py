...
parser.add_argument(
    "-i", "--iter", metavar="", default=int(60e3), type=int, help="Training epochs"
)
parser.add_argument(
...
parser.add_argument(
    ...
    default=None,
    type=int,
    help="Evaluate validation and test set every x steps. For every epoch use -1",
)
parser.add_argument(
    "-pr",
    "--prune_rate",
...
dataloader = data._dispatcher[datakey](
